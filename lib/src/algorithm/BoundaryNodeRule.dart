...
abstract class BoundaryNodeRule
{
  ...
  static final BoundaryNodeRule MOD2_BOUNDARY_RULE = new _Mod2BoundaryNodeRule();

  /// The Endpoint Boundary Node Rule.
  /// @see EndPointBoundaryNodeRule
  static final BoundaryNodeRule ENDPOINT_BOUNDARY_RULE = new _EndPointBoundaryNodeRule();

  /// The MultiValent Endpoint Boundary Node Rule.
  /// @see MultiValentEndPointBoundaryNodeRule
  static final BoundaryNodeRule MULTIVALENT_ENDPOINT_BOUNDARY_RULE = new _MultiValentEndPointBoundaryNodeRule();

  /// The Monovalent Endpoint Boundary Node Rule.
  /// @see MonoValentEndPointBoundaryNodeRule
  static final BoundaryNodeRule MONOVALENT_ENDPOINT_BOUNDARY_RULE = new _MonoValentEndPointBoundaryNodeRule();
  ...
  /// @author Martin Davis
  /// @version 1.7 
class _Mod2BoundaryNodeRule implements BoundaryNodeRule
  {
    @override
  bool isInBoundary(int boundaryCount)
    {
  ...
  /// @author Martin Davis
  /// @version 1.7
  class _EndPointBoundaryNodeRule
  ...
  class _MultiValentEndPointBoundaryNodeRule
      implements BoundaryNodeRule
  {
    @override
  bool isInBoundary(int boundaryCount)
  ...
  /// @author Martin Davis
  /// @version 1.7
class _MonoValentEndPointBoundaryNodeRule
      implements BoundaryNodeRule
  {
    @override
  bool isInBoundary(int boundaryCount)
