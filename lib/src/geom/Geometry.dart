...
abstract class Geometry{
  ...
  static const int TYPECODE_LINESTRING = 2;
  static const int TYPECODE_LINEARRING = 3;
  static const int TYPECODE_MULTILINESTRING = 4;
  static const int TYPECODE_POLYGON = 5;
  static const int TYPECODE_MULTIPOLYGON = 6;
  static const int TYPECODE_GEOMETRYCOLLECTION = 7;
  
  static const String TYPENAME_POINT = "Point";
  static const String TYPENAME_MULTIPOINT = "MultiPoint";
  static const String TYPENAME_LINESTRING = "LineString";
  static const String TYPENAME_LINEARRING = "LinearRing";
  static const String TYPENAME_MULTILINESTRING = "MultiLineString";
  static const String TYPENAME_POLYGON = "Polygon";
  ...
  ///@throws  ArgumentError  if <code>g</code> is a <code>GeometryCollection</code>
