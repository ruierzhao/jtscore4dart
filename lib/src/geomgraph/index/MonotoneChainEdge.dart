...
import 'MonotoneChainIndexer.dart';
...
class MonotoneChainEdge {
  ...
  MonotoneChainEdge(this.e)
      : pts = e.getCoordinates(),
        ...
        startIndex =
            MonotoneChainIndexer().getChainStartIndices(e.getCoordinates());

  MonotoneChainEdge.$2(this.e) : pts = e.getCoordinates() {
    MonotoneChainIndexer mcb = new MonotoneChainIndexer();
    startIndex = mcb.getChainStartIndices(pts);
  }
  ...
  /**private */ void _computeIntersectsForChain(int start0, int end0,
...
//Debug.println("computeIntersectsForChain:" + p00 + p01 + p10 + p11);
    ...
    if (start0 < mid0) {
      if (start1 < mid1)
        _computeIntersectsForChain(start0, mid0, mce, start1, mid1, ei);
      if (mid1 < end1)
        _computeIntersectsForChain(start0, mid0, mce, mid1, end1, ei);
    }
    if (mid0 < end0) {
      if (start1 < mid1)
        _computeIntersectsForChain(mid0, end0, mce, start1, mid1, ei);
      if (mid1 < end1)
        _computeIntersectsForChain(mid0, end0, mce, mid1, end1, ei);
    }
  }
