...
import 'package:jtscore4dart/src/operation/buffer/OffsetCurve.dart';

WKTWriter writer = WKTWriter();

Geometry read(String wktstr) {
...
void testZeroLenLine() {
  checkOffsetCurve("LINESTRING (1 1, 1 1)", 1, "LINESTRING EMPTY");
}

void testZeroOffsetLine() {
  checkOffsetCurve(
      "LINESTRING (0 0, 1 0, 1 1)", 0, "LINESTRING (0 0, 1 0, 1 1)");
}

void testZeroOffsetPolygon() {
  checkOffsetCurve(
      "POLYGON ((1 9, 9 1, 1 1, 1 9))", 0, "LINESTRING (1 9, 1 1, 9 1, 1 9)");
}
...
/**
   ...
   */
void testRepeatedPoint() {
  checkOffsetCurve("LINESTRING (4 9, 1 2, 7 5, 7 5, 4 9)", 1,
      "LINESTRING (4.24 7.02, 2.99 4.12, 5.48 5.36, 4.24 7.02)");
}

void testSegment1Short() {
  checkOffsetCurve("LINESTRING (2 2, 2 2.0000001)", 1,
      "LINESTRING (1 2, 1 2.0000001)", 0.00000001);
}

void testSegment1() {
  checkOffsetCurve(
      "LINESTRING (0 0, 9 9)", 1, "LINESTRING (-0.71 0.71, 8.29 9.71)");
}

void testSegment1Neg() {
  checkOffsetCurve(
      "LINESTRING (0 0, 9 9)", -1, "LINESTRING (0.71 -0.71, 9.71 8.29)");
}
...
//       input, 10, "LINESTRING (0 60, 75.85 60, 60 75.85, 60 0)");
...
// void testMinQuadrantSegments_QGIS() {
//   checkOffsetCurve(
...
/**private */ 
void checkOffsetCurve(String wkt, double distance, String wktExpected) {
  checkOffsetCurve2(wkt, distance, wktExpected, 0.05);
}

/**private */ void checkOffsetCurve2(String wkt, double distance, int quadSegs,
    int joinStyle, double mitreLimit, String wktExpected) {
  checkOffsetCurve(
      wkt, distance, quadSegs, joinStyle, mitreLimit, wktExpected, EQUALS_TOL);
}

/**private */ void checkOffsetCurveJoined(
    String wkt, double distance, String wktExpected) {
...
//     String wkt, double distance, String wktExpected, double tolerance) {
//   Geometry geom = read(wkt);
...
// /**private */ 
// void checkOffsetCurve(String wkt, double distance, int quadSegs,
//     int joinStyle, double mitreLimit, String wktExpected, double tolerance) {
//   Geometry geom = read(wkt);
//   Geometry result =
//       OffsetCurve.getCurve(geom, distance, quadSegs, joinStyle, mitreLimit);
//   //System.out.println(result);
